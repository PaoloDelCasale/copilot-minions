...
'@ | Set-Content -LiteralPath (Join-Path $bin 'git.cmd')
    ...
    Assert-True ($piControl.Contains('Triage: 8/20')) 'Control gate contains soft closure budget'
    Assert-True ($piControl.Contains('Triage: 20/20')) 'Control gate contains hard handoff budget'
