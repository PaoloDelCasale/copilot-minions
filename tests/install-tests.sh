...
grep -Eq 'mechanical.*grok-4\.5.*high' "${COPILOT_LB_MODELS}"
grep -Eq 'architect.*grok-4\.5.*high' "${COPILOT_LB_MODELS}"
...
grep -Eq 'architect.*grok-4\.5.*high' "${MINIONS_HOME}/.pi/agent/skills/pi-minions-lb/models.md"
